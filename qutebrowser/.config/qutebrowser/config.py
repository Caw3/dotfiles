...
## Type: QssColor
c.colors.completion.item.selected.bg = '#073655'
...
## Type: QtColor
c.colors.completion.item.selected.fg = '#e4e4e4'
...
## Type: QtColor
c.colors.completion.match.fg = '#e4e4e4'
...
## Type: QssColor
c.colors.completion.scrollbar.fg = '#e4e4e4'
...
config.bind('<Space>9', 'tab-focus -1')
...
config.bind('<Space><Tab>p', 'tab-pin')
...
config.bind('<Space><Tab>o', 'tab-only')
config.bind('<Space><Tab>c', 'tab-close')
# config.bind('f', 'hint')
# config.bind('g$', 'tab-focus -1')
# config.bind('g0', 'tab-focus 1')
# config.bind('gB', 'set-cmd-text -s :bookmark-load -t')
config.bind('<Space><Tab>C', 'tab-clone')
config.bind('<Space><Tab>D', 'tab-give')
config.bind('<Space><Tab>J', 'tab-move +')
config.bind('<Space><Tab>K', 'tab-move -')
