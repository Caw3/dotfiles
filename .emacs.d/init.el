...
(use-package eglot
  :ensure t
  :config
  (evil-define-key 'normal 'global (kbd "<leader>ds") 'eglot)
  (evil-define-key 'normal 'global (kbd "<leader>ca") 'eglot-code-actions)
  (evil-define-key 'normal 'global (kbd "<leader>rn") 'eglot-rename)
  (evil-define-key 'normal 'global (kbd "<leader>oi") 'eglot-code-action-organize-imports)
  (evil-define-key 'normal 'global (kbd "<leader>*") 'xref-find-references)
  (evil-define-key 'normal 'global (kbd "<leader>gd") 'eglot-find-declaration)
  (evil-define-key 'normal 'global (kbd "<leader>gt") 'eglot-find-typeDefinition)
  (evil-define-key 'normal 'global (kbd "M-RET") 'eglot-code-action-quickfix)
