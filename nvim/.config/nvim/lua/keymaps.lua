...
--Git
utils.nmap("<leader>gh", ":Telescope git_commits <CR>")
...
utils.nmap("<leader>gc", ":G commit <CR>")
...
utils.nmap("<leader>hs", ":Gitsigns stage_hunk<CR>")
utils.nmap("<leader>hS", ":Gitsigns stage_buffer<CR>")
utils.nmap("<leader>hr", ":Gitsigns reset_hunk<CR>")
utils.nmap("<leader>hR", ":Gitsigns reset_buffer<CR>")
utils.nmap("<leader>hd", ":Gitsigns toggle_deleted<CR>")
