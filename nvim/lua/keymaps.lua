...
nmap('<leader>fR',":Telescope find_files hidden=true prompt_title='Find in Root (hidden)' cwd=~<CR>")
nmap('<leader>fF',":Telescope find_files prompt_title='Find Files (hidden)' idden=true <CR>")
